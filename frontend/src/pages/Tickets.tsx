  ...
  <div className="flex items-center gap-2">
    <button
      ...
      className="px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 dark:hover:bg-gray-800"
    >
      Previous
    </button>
